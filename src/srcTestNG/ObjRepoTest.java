...
//import projectnew.costant;
//import projectnew.methodClass;
...
public class ObjRepoTest {
	 public String actionKeyword;
	    ...
	    static Properties obj1 = new Properties(); 
  ...
  private static void execute_Actions(String actionKeyword) throws Exception {
	  FileInputStream file=new FileInputStream("G://cpsatnewproject//projectnew//src//projectnew//obj1.properties");
	    obj1.load(file);
	  System.out.println(obj1.getProperty("Titleobj"));
	  System.out.println(obj1.getProperty("Tothemenuobj"));
	  System.out.println(obj1.getProperty("PrintTextobj"));
